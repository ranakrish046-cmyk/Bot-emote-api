...
Hr = {
    ...
    'Expect': "100-continue",
    'X-Unity-Version': "2019.4.40f1", # Standard Unity version for OB42/OB51
    'ReleaseVersion': "OB42",         # Change this to OB42 (or OB52 for today's update)
}
...
async def EncRypTMajoRLoGin(open_id, access_token):
    ...
    major_login.client_version = "1.120.3"
...
async def MaiiiinE():
    ...
    # BOT LOGIN UID
    BOT_UID = int('14390928370')  # <-- FIXED BOT UID
